...
$(eval $(call TERRAFORM_TASKS,d3,$$(AUTO_APPROVE)))
...
$(eval $(call TERRAFORM_TASKS,one,$$(AUTO_APPROVE)))
...
$(eval $(call SSH_TASKS,d3,$$(BECOME_ROOT),,debian@10.2.83.))
...
$(eval $(call SSH_TASKS,one,$$(BECOME_ROOT),,ubuntu@10.2.11.))
